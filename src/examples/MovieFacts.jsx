...
const GhibliMovieCard = () => {
  ...
  return (
    <div className="mb-5">
      ...
      <Button
        variant="link"
        onClick={() => setMovieId("58611129-2dbc-4a81-a72f-77ddfc1b1b49")}
      >
        My Neighbor Totoro
      </Button>
      <Button
        variant="link"
        onClick={() => setMovieId("0440483e-ca0e-4120-8c50-4c8cd9b965d6")}
      >
        Princess Mononoke
      </Button>
      <Button
        variant="link"
        onClick={() => setMovieId("ea660b10-85c4-4ae3-8a5f-41cea3648e3e")}
      >
